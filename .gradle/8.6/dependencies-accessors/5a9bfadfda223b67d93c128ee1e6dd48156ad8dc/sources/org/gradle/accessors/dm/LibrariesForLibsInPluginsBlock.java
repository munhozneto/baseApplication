...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final DataLibraryAccessors laccForDataLibraryAccessors = new DataLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>data</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public DataLibraryAccessors getData() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForDataLibraryAccessors;
    }
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>compose.viewmodel</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class DataLibraryAccessors extends SubDependencyFactory {

        public DataLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>store</b> with <b>androidx.datastore:datastore-preferences</b> coordinates and
         * with version reference <b>data.store</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final DataVersionAccessors vaccForDataVersionAccessors = new DataVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>agp</b> with value <b>8.5.0-alpha02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>composeBom</b> with value <b>2024.03.00</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.data</b>
         */
        public DataVersionAccessors getData() {
            return vaccForDataVersionAccessors;
        }
    ...
    public static class CoilVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coil.compose</b> with value <b>2.2.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.viewmodel</b> with value <b>2.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getViewmodel() { return getVersion("compose.viewmodel"); }
    ...
    public static class CoroutinesVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>coroutines.test</b> with value <b>1.7.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class DataVersionAccessors extends VersionFactory  {

        public DataVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>data.store</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getStore() { return getVersion("data.store"); }
